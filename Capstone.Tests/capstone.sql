...
INSERT INTO park (park_id, name, location, establish_date, area, visitors, description) VALUES (1, 'FAKEASS PARK', 'fake state', '2005-02-03', 13000, 10000, 'These are fact I just made up about this park...story has it this is the place where Chewbacca won a cage match against Big Foot');
